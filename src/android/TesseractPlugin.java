  ...
  private static final String TAG = "SimpleAndroidOCR.java";
	...
	public boolean execute(String action, JSONArray args,
        ...
        if (!(new File(DATA_PATH + "/tessdata/eng.traineddata")).exists()) {
            callbackContext.error(DATA_PATH + "/tessdata/eng.traineddata não encontrado");
            return false;
        }
				...
				//String imagePath = DATA_PATH + "/cracha.jpg";

        if (imagePath.equals("storage")) {
            imagePath = DATA_PATH + "/cracha.jpg";
        }
        ...
        if (recognizedText == null) {
          callbackContext.error("Cracha não encontrado");
          return false;
        }

				this.echo(recognizedText, callbackContext);
				return true;
			}
	...
	public String TesseractExampleTwo(String pathToPic)
	{
